...
var rootCmd = &cobra.Command{
	Use:   "modeanalytics",
	Short: "CLI client for Mode Analytics REST API",
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.config/.modeanalytics.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".modeanalytics")
	}
